                    ...
                    onClick={async () => {
                      try {
                        ...
                        if (pipelines.length === 0) {
                          alert('Chưa có Pipeline nào trong CRM');
                          return;
                        }
                        const stages = await CRMService.getStages(pipelines[0].id);
                        if (stages.length === 0) {
                          alert('Pipeline chưa có Stage nào');
                          return;
                        }
                        ...
                        alert('Đã đẩy thành công sang CRM!');
                      } catch (error) {
                        console.error(error);
